    ...
    <div style={{ 
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
          ...
          <a href="/blog" target="_blank" rel="noopener noreferrer" style={{ color: '#64748b', textDecoration: 'none', fontSize: '14px', fontWeight: '500' }}>Blog</a>
          <a 
            href="#signup"
            style={{ 
      ...
      <section style={{
        ...
        <div className="stats-row" style={{
          ...
          <div>
            <div style={{ fontSize: '32px', fontWeight: '700', color: '#1a1a2e' }}>6</div>
      ...
      <section id="about" style={{
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Off Market Daily gives cash buyers and real estate investors first access to vetted investment deals before they go anywhere else. Properties sent direct across Arizona, Georgia, Florida, Texas, Colorado, and North Carolina.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <p style={{ color: '#64748b', lineHeight: '1.7' }}>
              Off Market Daily is a deal flow platform that sends off market investment properties directly to real estate investors. We source properties across Arizona, Georgia, Florida, Texas, Colorado, and North Carolina — delivering deals with real margins for BRRRR, rentals, and fix & flip strategies.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <p style={{ color: '#64748b', lineHeight: '1.7' }}>
              We currently source off market properties in Arizona (Phoenix, Mesa, Tucson), Georgia (Atlanta, Macon), Florida (Tampa, Orlando, Miami), Texas (Dallas, Austin, San Antonio), Colorado (Denver, Colorado Springs), North Carolina (Charlotte, Greensboro).
            </p>
          </div>
