...
export const metadata = {
  title: 'Off Market Properties for Investors | BRRRR, Rentals & Flips | 6 States',
  ...
  openGraph: {
    title: 'Off Market Investment Properties | 6 States | Join Free',
    description: 'First access to off market properties with real margins. BRRRR, rentals, and flip deals across AZ, GA, FL, TX, CO, NC.',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'First access to off market deals with real margins. BRRRR, rentals, flips across 6 states.',
  },
  robots: 'index, follow',
  alternates: {
...
export default function RootLayout({ children }) {
  const structuredData = {
    ...
    "description": "Off Market Daily is a deal flow platform that sends off market investment properties directly to real estate investors. Properties include BRRRR deals, rental properties, and fix & flip opportunities across Arizona, Georgia, Florida, Texas, Colorado, North Carolina.",
    "url": "https://offmarketdaily.com",
    "areaServed": [
      "Arizona", "Georgia", "Florida", "Texas", "Colorado", "North Carolina",     ],
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Off Market Daily is a deal flow platform that sends off market investment properties directly to real estate investors. We source properties across Arizona, Georgia, Florida, Texas, Colorado, and North Carolina — delivering deals with real margins for BRRRR, rentals, and fix & flip strategies."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We currently source off market properties in Arizona, Georgia, Florida, Texas, Colorado, and North Carolina."
        }
      },
      {
        "@type": "Question",
